...
public class AbstractAvr implements Cloneable {
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.BRBC insn) {
    ...
    if (bit == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(0, FALSE); 
        fork.setStatusBit(0, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.BREQ insn) {
    ...
    if (this.zeroFlag == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(4, FALSE); 
        fork.setStatusBit(4, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.BRGE insn) {
    ...
    if (this.zeroFlag == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(2, FALSE); 
        fork.setStatusBit(2, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.BRTS insn) {
    ...
    if (this.bitcopyFlag == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(6, FALSE); 
        fork.setStatusBit(6, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.BRVC insn) {
    ...
    if (this.overflowFlag == FALSE) {
      this.programCounter = (this.programCounter + insn.k + 1);
      return this;
    } else if (this.overflowFlag == TRUE) {
      this.programCounter = this.programCounter + 1;
      return this;
    }
    if (this.overflowFlag == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(3, FALSE); 
        fork.setStatusBit(3, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.SBIC insn) {
    ...
    if (iob == UNKNOWN) {
        fork = this.clone(); 
        fork.programCounter = this.programCounter;
        this.setStatusBit(1, FALSE); 
        fork.setStatusBit(1, TRUE);
    }
    //
    return fork;
  }
  ...
  private @Nullable AbstractAvr execute(AvrInstruction.SBR insn) {
	  this.programCounter = this.programCounter + 1;
	    Byte a = this.data.read(insn.Rd);
	    this.data.write(insn.Rd, a.set(insn.K));
	    // 
	    return null;
  }
