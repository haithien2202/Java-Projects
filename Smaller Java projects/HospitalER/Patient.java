...
public class Patient implements Comparable<Patient>{
    ...
    public void advanceTreatmentByTick(){
        if (completedCurrentTreatment() && !noMoreTreatments1()){
            treatmentTimes.set(currentTreatment+1, treatmentTimes.get(currentTreatment)-1);
        }
        totalTreatmentTime++;
        if (treatmentTimes.get(currentTreatment) > 0){
    ...
    public boolean noMoreTreatments1(){
    ...
    public void incrementTreatmentNumber1(){
        if (noMoreTreatments()){
            throw new RuntimeException("patient already completed: "+this);
        }
        currentTreatment++;
