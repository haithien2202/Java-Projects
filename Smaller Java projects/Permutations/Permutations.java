...
public class Permutations {
    ...
    public void extendPermutation(Set<String> remainingItems, Stack<String> permutationSoFar, List<List<String>> allPermutations){
        ...
        // if (remainingItems == null || permutationSoFar == null || allPermutations == null) return;
        if (remainingItems.size() == 0){
            List<String> newList = new ArrayList<String>();
            newList.addAll(permutationSoFar);
            allPermutations.add(newList);
        } else {
            Set<String>temp = new HashSet<>(remainingItems);
